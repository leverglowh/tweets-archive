...
def url(item):
    return "https://twitter.com/leverglowh/status/" + item["id_str"]
...
<head>
  ...
  <title>leverglowh twitter archive</title>
...
<body>
  <div class="wrapper" id="app">
    <h1><a href="../../..">leverglowh twitter archive</a></h1>
          ...
          <div><div class="tweet-header">
              ...
              <div class="tweet-name-row">
                <div class="fullname-and-username">
                  <a class="fullname" href="/" title="leverglowh">leverglowh</a>
                  <a class="username" href="/" title="@leverglowh">@leverglowh</a>
                </div>
...
def main():
    data = read_data()
    for item in data:
        os.makedirs(f"leverglowh/status/{item['id_str']}", exist_ok=True)
        with open(f"./leverglowh/status/{item['id_str']}/index.html", "w") as f:
